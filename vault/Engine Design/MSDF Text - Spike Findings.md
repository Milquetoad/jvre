...
**Status: spike COMPLETE; decision made.** This resolves the catalogued "MSDF — STILL A SPIKE (L + a decision)" item from [[Roadmap|Batch 3]]. The headline: **the spike's founding assumption was stale, and the conclusion flips because of it.**
